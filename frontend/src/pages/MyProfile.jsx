...
const MyProfile = () => {
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      formData.append('gender', userData.gender); // Ensure gender is correctly appended
      ...
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        ...
        ? <label htmlFor="image">
            <div className="inline-block relative cursor-pointer">
              <img className="w-26 rounded opacity-75" src={image ? URL.createObjectURL(image) : userData.image} alt="" />
